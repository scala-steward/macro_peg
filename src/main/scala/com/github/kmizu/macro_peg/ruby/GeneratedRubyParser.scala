...
object GeneratedRubyParser {
 ...
 _scanSimpleBody(input, pos, '+') 
  ...
  Some((_rs1387, _cp1388)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r1327, _p1328) => (new ~(_r1325, _r1327), _p1328) } }.flatMap { case (_r1321, _p1322) => {
  ...
  Some((_rs1484, _cp1485)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r1452, _p1453) => (new ~(_r1450, _r1452), _p1453) } }.flatMap { case (_r1446, _p1447) => {
  ...
  Some((_rs1542, _cp1543)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r1523, _p1524) => (new ~(_r1521, _r1523), _p1524) } }.flatMap { case (_r1517, _p1518) => {
  ...
  Some((_rs1590, _cp1591)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r1571, _p1572) => (new ~(_r1569, _r1571), _p1572) } }.flatMap { case (_r1565, _p1566) => {
  ...
  Some((_rs1659, _cp1660)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r1631, _p1632) => (new ~(_r1629, _r1631), _p1632) } }.flatMap { case (_r1625, _p1626) => {
  ...
  Some((_rs2041, _cp2042)) }.map { case (_r2039, _p2040) => (new ~(_r2037, _r2039), _p2040) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }

  def parsePowerExpr(input: String, pos: Int): Option[(Any, Int)] = _withMemo(32, pos) {
    parsePostfixExpr(input, pos).flatMap { case (_r2046, _p2047) => ((if (input.startsWith("**", _p2047)) Some(("**", _p2047 + 2)) else None).flatMap { case (_r2054, _p2055) => parseSpacing(input, _p2055).map { case (_r2056, _p2057) => (new ~(_r2054, _r2056), _p2057) } }.flatMap { case (_r2050, _p2051) => parsePowerExpr(input, _p2051).map { case (_r2052, _p2053) => (new ~(_r2050, _r2052), _p2053) } }.map { case (v, p) => (Some(v), p) }.orElse(Some((None, _p2047)))).map { case (_r2048, _p2049) => (new ~(_r2046, _r2048), _p2049) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }

  def parseUnaryOpSym(input: String, pos: Int): Option[(Any, Int)] = ((((((if (input.startsWith("not", pos)) Some(("not", pos + 3)) else None).flatMap { case (_r2062, _p2063) => (if (parseIdentCont(input, _p2063).isEmpty) Some(((), _p2063)) else None).map { case (_r2064, _p2065) => (new ~(_r2062, _r2064), _p2065) } }.flatMap { case (_r2058, _p2059) => parseSpacing(input, _p2059).map { case (_r2060, _p2061) => (new ~(_r2058, _r2060), _p2061) } }).orElse((if (input.startsWith("!", pos)) Some(("!", pos + 1)) else None))).orElse((if (input.startsWith("~", pos)) Some(("~", pos + 1)) else None))).orElse((if (input.startsWith("-", pos)) Some(("-", pos + 1)) else None))).orElse((if (input.startsWith("+", pos)) Some(("+", pos + 1)) else None))).orElse((if (input.startsWith("*", pos)) Some(("*", pos + 1)) else None)).map { case (r, p) => (_applyAction({  _ => ""  }, r), p) }

  def parseUnaryExpr(input: String, pos: Int): Option[(Any, Int)] = _withMemo(33, pos) {
    (parseUnaryOpSym(input, pos).flatMap { case (_r2070, _p2071) => parseSpacing(input, _p2071).map { case (_r2072, _p2073) => (new ~(_r2070, _r2072), _p2073) } }.flatMap { case (_r2066, _p2067) => parseUnaryExpr(input, _p2067).map { case (_r2068, _p2069) => (new ~(_r2066, _r2068), _p2069) } }).orElse(parsePowerExpr(input, pos)).map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2078, _cp2079)) }.map { case (_r2076, _p2077) => (new ~(_r2074, _r2076), _p2077) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2107, _cp2108)) }.map { case (_r2105, _p2106) => (new ~(_r2103, _r2105), _p2106) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2132, _cp2133)) }.map { case (_r2130, _p2131) => (new ~(_r2128, _r2130), _p2131) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2153, _cp2154)) }.map { case (_r2151, _p2152) => (new ~(_r2149, _r2151), _p2152) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2174, _cp2175)) }.map { case (_r2172, _p2173) => (new ~(_r2170, _r2172), _p2173) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2199, _cp2200)) }.map { case (_r2197, _p2198) => (new ~(_r2195, _r2197), _p2198) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2224, _cp2225)) }.map { case (_r2222, _p2223) => (new ~(_r2220, _r2222), _p2223) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2261, _cp2262)) }.map { case (_r2259, _p2260) => (new ~(_r2257, _r2259), _p2260) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs2282, _cp2283)) }.map { case (_r2280, _p2281) => (new ~(_r2278, _r2280), _p2281) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs3104, _cp3105)) }.map { case (_r3102, _p3103) => (new ~(_r3100, _r3102), _p3103) } }.map { case (r, p) => (_applyAction({  _ => NilLiteral()  }, r), p) }
  }
  ...
  Some((_rs3170, _cp3171)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3151, _p3152) => (new ~(_r3149, _r3151), _p3152) } }.flatMap { case (_r3145, _p3146) => {
  ...
  Some((_rs3228, _cp3229)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3209, _p3210) => (new ~(_r3207, _r3209), _p3210) } }.flatMap { case (_r3203, _p3204) => {
  ...
  Some((_rs3276, _cp3277)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3257, _p3258) => (new ~(_r3255, _r3257), _p3258) } }.flatMap { case (_r3251, _p3252) => {
  ...
  Some((_rs3389, _cp3390)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3358, _p3359) => (new ~(_r3356, _r3358), _p3359) } }.flatMap { case (_r3352, _p3353) => {
  ...
  Some((_rs3468, _cp3469)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3422, _p3423) => (new ~(_r3420, _r3422), _p3423) } }.flatMap { case (_r3416, _p3417) => {
  ...
  Some((_rs3532, _cp3533)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3513, _p3514) => (new ~(_r3511, _r3513), _p3514) } }.flatMap { case (_r3507, _p3508) => {
  ...
  Some((_rs3619, _cp3620)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3569, _p3570) => (new ~(_r3567, _r3569), _p3570) } }.flatMap { case (_r3563, _p3564) => {
  ...
  Some((_rs3722, _cp3723)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3672, _p3673) => (new ~(_r3670, _r3672), _p3673) } }.flatMap { case (_r3666, _p3667) => {
  ...
  Some((_rs3778, _cp3779)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3759, _p3760) => (new ~(_r3757, _r3759), _p3760) } }.flatMap { case (_r3753, _p3754) => {
  ...
  Some((_rs3871, _cp3872)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3807, _p3808) => (new ~(_r3805, _r3807), _p3808) } }.flatMap { case (_r3801, _p3802) => {
  ...
  Some((_rs3983, _cp3984)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r3964, _p3965) => (new ~(_r3962, _r3964), _p3965) } }.flatMap { case (_r3958, _p3959) => {
  ...
  Some((_rs4455, _cp4456)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4448, _p4449) => (new ~(_r4446, _r4448), _p4449) } }.flatMap { case (_r4442, _p4443) => {
  ...
  Some((_rs4513, _cp4514)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4494, _p4495) => (new ~(_r4492, _r4494), _p4495) } }.flatMap { case (_r4488, _p4489) => {
  ...
  Some((_rs4561, _cp4562)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4542, _p4543) => (new ~(_r4540, _r4542), _p4543) } }.flatMap { case (_r4536, _p4537) => {
  ...
  Some((_rs4629, _cp4630)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4598, _p4599) => (new ~(_r4596, _r4598), _p4599) } }.flatMap { case (_r4592, _p4593) => {
  ...
  Some((_rs4706, _cp4707)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4667, _p4668) => (new ~(_r4665, _r4667), _p4668) } }.flatMap { case (_r4661, _p4662) => {
  ...
  Some((_rs4762, _cp4763)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4739, _p4740) => (new ~(_r4737, _r4739), _p4740) } }.flatMap { case (_r4733, _p4734) => {
  ...
  Some((_rs4845, _cp4846)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4795, _p4796) => (new ~(_r4793, _r4795), _p4796) } }.flatMap { case (_r4789, _p4790) => {
  ...
  Some((_rs4928, _cp4929)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4878, _p4879) => (new ~(_r4876, _r4878), _p4879) } }.flatMap { case (_r4872, _p4873) => {
  ...
  Some((_rs5031, _cp5032)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r4961, _p4962) => (new ~(_r4959, _r4961), _p4962) } }.flatMap { case (_r4955, _p4956) => {
  ...
  Some((_rs5099, _cp5100)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r5080, _p5081) => (new ~(_r5078, _r5080), _p5081) } }.flatMap { case (_r5074, _p5075) => {
  ...
  Some((_rs5157, _cp5158)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r5138, _p5139) => (new ~(_r5136, _r5138), _p5139) } }.flatMap { case (_r5132, _p5133) => {
  ...
  Some((_rs5205, _cp5206)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r5186, _p5187) => (new ~(_r5184, _r5186), _p5187) } }.flatMap { case (_r5180, _p5181) => {
  ...
  Some((_rs5292, _cp5293)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r5242, _p5243) => (new ~(_r5240, _r5242), _p5243) } }.flatMap { case (_r5236, _p5237) => {
  ...
  Some((_rs5395, _cp5396)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r5345, _p5346) => (new ~(_r5343, _r5345), _p5346) } }.flatMap { case (_r5339, _p5340) => {
  ...
  Some((_rs5451, _cp5452)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r5432, _p5433) => (new ~(_r5430, _r5432), _p5433) } }.flatMap { case (_r5426, _p5427) => {
  ...
  Some((_rs5539, _cp5540)) }.map { case (r, p) => (_applyAction({  _ => List.empty[Statement]  }, r), p) }.map { case (_r5520, _p5521) => (new ~(_r5518, _r5520), _p5521) } }.flatMap { case (_r5514, _p5515) => {
  ...
  Some((_rs5594, _cp5595)) }.map { case (_r5592, _p5593) => (new ~(_r5590, _r5592), _p5593) } }.map { case (r, p) => (_applyAction({  _ => ExprStmt(NilLiteral())  }, r), p) }
  }
